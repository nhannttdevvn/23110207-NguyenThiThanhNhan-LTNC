    ...
    public partial class CreateApp : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAdminAccounts", x => x.AdminId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeTown = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasePrice = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_AppUsers_EmployeeId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "AdminId", "CreatedDate", "IsActive", "PasswordHash", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 10, 9, 34, 8, 594, DateTimeKind.Local).AddTicks(1914), true, "3BmjuYXFXJbam8BklJ44FQ==.eaqExE9c2K+XnxlI+BGX1C5n3ejIw6g4Rw0390y75Vc=", "admin" });
