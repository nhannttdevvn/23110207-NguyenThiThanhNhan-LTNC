...
namespace PhoneStoreManagement.Winforms
{
    public partial class SupplierForm : Form
    {
        ...
        private async void SupplierForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lỗi khởi tạo danh sách: " + ex.Message);
            }
        }
        ...
        private async void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lỗi khi thêm: " + (ex.InnerException?.Message ?? ex.Message));
            }
        }
        ...
        private async void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không thể xóa vì còn sản phẩm liên quan đến nhà cung cấp này", "Lỗi ràng buộc");
            }
            catch (Exception ex)
            {
